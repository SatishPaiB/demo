$(function() {
    $.widget("flowchart.flowchart", {
        ...
        globalId: null,
        _create: function() {
            "undefined" == typeof document.__flowchartNumber ? document.__flowchartNumber = 0 : document.__flowchartNumber++, this.globalId = document.__flowchartNumber, this._unitVariables(), this.element.addClass("flowchart-container"), this.objs.layers.links = $('<svg class="flowchart-links-layer"></svg>'), this.objs.layers.links.appendTo(this.element), this.objs.layers.operators = $('<div class="flowchart-operators-layer unselectable"></div>'), this.objs.layers.operators.appendTo(this.element), this.objs.layers.temporaryLink = $('<svg class="flowchart-temporary-link-layer"></svg>'), this.objs.layers.temporaryLink.appendTo(this.element);
        ...
        _initEvents: function() {
            ...
            this.element.mousemove(function(e) {
                ...
                var e = $(this);
                t.options.canUserEditLinks && t._connectorClicked(e.closest(".flowchart-operator").data("operator_id"), e.data("connector"), e.data("sub_connector"), e.closest(".flowchart-operator-connector-set").data("connector_type"))
        ...
        addLink: function(t) {
            for (;
                "undefined" != typeof this.data.links[this.linkNum];) this.linkNum++;
            ...
            if (this.callbackEvent("linkCreate", [t, r])) {
                ...
                if (!i || !s)
                    for (var l in this.data.links)
                        ...
                        } this._autoCreateSubConnector(r.fromOperator, r.fromConnector, "outputs", n), this._autoCreateSubConnector(r.toOperator, r.toConnector, "inputs", a), this.data.links[t] = r, this._drawLink(t), this.callbackEvent("afterChange", ["link_create"])
            }
        },
        _autoCreateSubConnector: function(t, e, r, o) {
            var n = this.data.operators[t].properties[r][e];
            if (n.multiple)
                for (var a = this.data.operators[t].internal.els, i = this.data.operators[t].internal.els.connectors[e].length, s = i; o + 2 > s; s++) this._createSubConnector(e, n, a)
        },
        ...
        _refreshLinkPositions: function(t) {
            ...
            e.internal.els.path.setAttribute("d", "M" + d + "," + c + " C" + (s + l + h + v) + "," + c + " " + (p - v) + "," + u + " " + f + "," + u), e.internal.els.rect.setAttribute("x", s), e.internal.els.rect.setAttribute("y", c - this.options.linkWidth / 2), e.internal.els.rect.setAttribute("width", l + h + 1), e.internal.els.rect.setAttribute("height", this.options.linkWidth)
        },
        ...
        addOperator: function(t) {
            for (;
                "undefined" != typeof this.data.operators[this.operatorNum];) this.operatorNum++;
        ...
        createOperator: function(t, e) {
            ...
            o && (e.top = Math.round(e.top / o) * o, e.left = Math.round(e.left / o) * o), r.operator.appendTo(this.objs.layers.operators), r.operator.css({
                top: e.top,
                left: e.left
            }), r.operator.data("operator_id", t), this.data.operators[t] = e, this.data.operators[t].internal.els = r, t == this.selectedOperatorId && this._addSelectedClass(t);
            var n = this;
                ...
                r.operator.draggable({
                    ...
                    drag: function(t, o) {
                        if (n.options.grid) {
                            ...
                            o.offset.left = Math.round(o.position.left + c.left), o.offset.top = Math.round(o.position.top + c.top), r.operator.css({
                    ...
                    stop: function(t, e) {
                        ...
                        a(o, e.position), r.operator.css({
                            height: "auto"
                        }), n.callbackEvent("operatorMoved", [o, e.position]), n.callbackEvent("afterChange", ["operator_moved"])
                    }
                })
            }
        ...
        _openForm: function(t){
            if(this.data.operators[t].internal.properties.title == "RSI"){
                ...
                document.getElementById("myForm_output").style.display = "none";
            ...
            }else if(this.data.operators[t].internal.properties.title == "خروجی"){
                document.getElementById("myForm_rsi").style.display = "none";
                document.getElementById("myForm_macd").style.display = "none";
                document.getElementById("myForm_if").style.display = "none";
                document.getElementById("myForm_input").style.display = "none";
                document.getElementById("myForm_output").style.display = "block";
        ...
        setOperatorTitle: function(t, e) {
            this.data.operators[t].internal.els.title.html(e), "undefined" == typeof this.data.operators[t].properties && (this.data.operators[t].properties = {}), this.data.operators[t].properties.title = e, this._refreshInternalProperties(this.data.operators[t]), this.callbackEvent("afterChange", ["operator_title_change"])
        },
